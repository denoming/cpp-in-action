...
function(checkForCxx11Compiler _VAR)
    ...
    try_compile(_COMPILER_TEST_RESULT ${PROJECT_BINARY_DIR} ${CMAKE_CURRENT_LIST_DIR}/common/TestCompiler.cpp
    ...
    if(NOT _COMPILER_TEST_RESULT AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      try_compile(_COMPILER_TEST_RESULT ${PROJECT_BINARY_DIR} ${CMAKE_CURRENT_LIST_DIR}/common/TestCompiler.cpp
                  CMAKE_FLAGS -DCMAKE_CXX_FLAGS="-stdlib=libc++" -DCMAKE_CXX_STANDARD=11 -DCMAKE_CXX_STANDARD_REQUIRED=ON)
    ...
    if(_COMPILER_TEST_RESULT AND (CMAKE_COMPILER_IS_GNUCXX AND NOT ${CMAKE_CXX_COMPILER_VERSION} VERSION_LESS 4.8.1) OR
...
function(checkForCxx14Compiler _VAR)
    ...
    if(NOT _COMPILER_TEST_RESULT AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      try_compile(_COMPILER_TEST_RESULT ${PROJECT_BINARY_DIR} ${CMAKE_CURRENT_LIST_DIR}/common/TestCompiler.cpp
                  CMAKE_FLAGS -DCMAKE_CXX_FLAGS="-stdlib=libc++" -DCMAKE_CXX_STANDARD=14 -DCMAKE_CXX_STANDARD_REQUIRED=ON)
      if(_COMPILER_TEST_RESULT)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -stdlib=libc++" PARENT_SCOPE)
      else()
